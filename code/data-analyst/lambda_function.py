    ...
    try:
        ...
        try:
            if question_query_map:
                ...
                message, status_code = write_to_cache(expl_model_id, embedding_model_id, question_query_map, vector_db_params)
        ...
        if cached_flag:
            ...
            try:
                ...
                if error_msg != '':
                    ...
                    answer_gen, error_msg = generate_answer_en(chat_model_id, df, sql, messages)
                else:
                    answer_gen = ''
                time_tracker.end_process(iteration_id)
