    ...
    def _create_lambda_functions(self):
        ...
        self.querybot_lambda = _lambda.Function(
            ...
            environment={
                ...
                "SQL_MODEL_ID": metadata_dict.get("sql_model_id", "anthropic.claude-3-sonnet-20240229-v1:0"),
                "CHAT_MODEL_ID": metadata_dict.get("chat_model_id", "anthropic.claude-3-haiku-20240307-v1:0"),
                "EMBEDDING_MODEL_ID": metadata_dict.get("embedding_model_id", "cohere.embed-multilingual-v3"),
                "APPROACH": metadata_dict.get("approach", "few_shot"),
